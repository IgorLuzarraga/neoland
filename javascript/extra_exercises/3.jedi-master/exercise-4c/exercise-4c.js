// Basandote en el ejercicio anterior. Crea un botón para 
// cada uno de los elementos de las listas que elimine 
  ...
  const createPlacesList = (places) => {
        ...
        places.forEach((place, index) => {
            ...
            btn.addEventListener('click', () => {
                const divToRemove = document.querySelector(`#li_${index}`)
                divToRemove.remove()
            })
